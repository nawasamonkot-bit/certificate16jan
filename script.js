...
//-----------------------------------------------------------
function resetData() {
  if (!confirm("ต้องการรีเซ็ตข้อมูลทั้งหมดและเริ่มเลขใหม่เป็น 001 ใช่ไหม?")) return;

  localStorage.removeItem("cert_logs");    // ลบข้อมูลทั้งหมด
  logs = [];                                // รีเซ็ตตัวแปรในหน้าเว็บด้วย

  alert("รีเซ็ตสำเร็จ! เลขรันกลับไปเป็น 001 แล้ว");
}
